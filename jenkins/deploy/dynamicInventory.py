...
def main ():
  aws_creds = yaml.load(open("vars/dynamicHosts.yaml", "r"))["boto3"]
  ansible = yaml.load(open("vars/dynamicHosts.yaml", "r"))["ansible"]
  env = yaml.load(open("vars/dynamicHosts.yaml", "r"))["env"]
