...
def main ():
  aws_creds = yaml.load(open("dynamicHosts.yaml", "r"), Loader=yaml.FullLoader)["boto3"]
  ansible = yaml.load(open("dynamicHosts.yaml", "r"), Loader=yaml.FullLoader)["ansible"]
  env = yaml.load(open("dynamicHosts.yaml", "r"), Loader=yaml.FullLoader)["env"]

  ec2 = boto3.resource('ec2', region_name=aws_creds["region"], aws_access_key_id=aws_creds["access_key"], aws_secret_access_key=aws_creds["secret_access_key"])
